...
**Table 1** below shows the variables and their attributes. 
...
This data was reduced to **1000** observations through a random generation of row numbers. The variable "ISO" was removed as it was not necessary for analysis. 